function [mumyperm,mumyporo,mumyfault]=main_ESMDA(nx,ny,nz,N,tol,observation,overallsim,rossmary,rossmaryporo,perm,poro,faulten,history,alpha,effective);
...
f=observation(:,i);
[DupdateK,sgsimporosity,faultout] = ESMDA (sgactual,sgporoactual,faulten,f, N, Sim1,alpha,tol,indices);
