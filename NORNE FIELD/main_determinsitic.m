function [mumyperm,mumyporo,mumyfault]=main_determinsitic(nx,ny,nz,N,tol,observation,overallsim,rossmary,rossmaryporo,perm,poro,faulten,history,alpha,effective);
...
f=observation(:,i);
[DupdateK,sgsimporosity,faultout] = deterministic(sgactual,sgporoactual,faulten,f, N, Sim1,alpha,tol,indices);
