function [mumyperm,mumyporo,mumyfault]=main_DCT_EnKF(nx,ny,nz,N,tol,observation,overallsim,rossmary,rossmaryporo,perm,poro,faulten,history,alpha,effective);
...
f=observation(:,i);
 sgsim11 = reshape(clement2,27500,N);
 sgsim11poro = reshape(clement2poro,27500,N);
...
overall=zeros(55119,N); 

overall(1:27500,1:N)=sgsim11;
overall(27501:55000,1:N)=sgsim11poro;
overall(55001:55053,1:N)=faulten;
overall(55054:55119,1:N)=Simuse;
...
clement2=(value1);
clement2poro=Ynew(44432:88862,1:N);
...
%DupdateK2(DupdateK2>=3996.5)=3996.5;
DupdateK2(DupdateK2<=0.6550)=0.6550;
...
mumyfault=Ynew(55001:55053,1:N);
%faultout=abs(faultout);
mumyfault(mumyfault<=0.000036182)=0.000036182;
end
