function [DupdateK,sgsimporosity,faultout]= Assimilate_DCT (clement2,clement2poro,faulten,f, N, Sim1,alpha,tol,indices)
%-----------------------------------------------------------------------------
...
value1=Ynew(1:27500,1:N);
DupdateK=(value1);
sgsimporosity=Ynew(27501:55000,1:N);
faultout=Ynew(55001:55053,1:N);
end